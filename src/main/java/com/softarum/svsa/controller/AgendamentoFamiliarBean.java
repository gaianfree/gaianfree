...
private static final long serialVersionUID = 1L;
	...
	private void buscarAtendimentoFamiliar(Unidade unidade) {
		listaAtendimentos = agendamentoFamiliarService.buscarAtendimentosAgendados(unidade, loginBean.getTenantId());
	...
	public void selecionarPessoaReferencia(SelectEvent<?> event) {			
		...
		item.setPessoas(pessoaReferencia.getFamilia().getMembros());
