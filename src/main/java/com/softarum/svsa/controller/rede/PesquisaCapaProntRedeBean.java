...
@Getter
@Setter
@Named(value="pesquisaProntRedeBean")
@ViewScoped   
public class PesquisaCapaProntRedeBean implements Serializable {
...
private static final long serialVersionUID = 1L;
	...
	public void inicializar() {		
		lazyProntuarios = new LazyProntuario(prontuarioService, loginBean.getUsuario().getUnidade().getUnidadeVinculada(), loginBean.getTenantId());
	}
