...
@Entity
@NamedQueries({	
	@NamedQuery(name="CondicaoTrabalho.obterCondicaoTrabalho", query="select c from CondicaoTrabalho c where "
			+ "c.pessoa = :pessoa "
			+ "and c.tenant_id = :tenantId")	
})
public class CondicaoTrabalho implements Serializable {
